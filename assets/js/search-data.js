    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-student-volunteer-for-citation-check-on-two-accepted-papers-in-soups-2026",
          title: 'Student volunteer for citation check on two accepted papers in SOUPS 2026.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=BI04NrsAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
